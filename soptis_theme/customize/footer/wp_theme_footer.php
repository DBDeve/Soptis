<?php
    ...
    function soptis_footer_render() {
        $number_of_columns = absint( get_theme_mod( 'soptis_footer_content_number', 4 ) );
        ...
        for ( $i = 1; $i <= $number_of_columns; $i++ ) {
            ...
            echo '<div id="footer_column_'.esc_attr( $i ).'" >';
                ...
                if($i === 1){
                    ...
                    $text_boolean = (bool) get_theme_mod( "soptis_footer_column_1_text_boolean", true) ;
                    if($text_boolean){

                        $text_align_value_db = get_theme_mod("soptis_footer_column_1_text_align", "center");
                ...
                if($i === 4){
                    $maps_boolean = (bool) get_theme_mod("soptis_footer_column_4_maps", true);
                    if($maps_boolean){

                        $maps_align_value_db = get_theme_mod("soptis_footer_column_4_maps_align", "center");
                        ...
                        $maps_link_db= get_theme_mod("soptis_footer_column_4_maps_link", 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12367353.697823416!2d2.1183282868056765!3d40.81975990771308!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12d4fe82448dd203%3A0xe22cf55c24635e6f!2sItalia!5e0!3m2!1sit!2sit!4v1771685477293!5m2!1sit!2sit');
                ...
                if($i === 3){
                    $navbar_boolean = (bool) get_theme_mod("soptis_footer_column_3_navbar", true);
                    if($navbar_boolean){
                        echo '<div class="navbar_container">';
                        
                            $navbar_number_db = get_theme_mod("soptis_footer_column_3_navbar_number",1);
                            $navbar_number = absint( $navbar_number_db );

                            for($y=1; $y <= $navbar_number; $y++){

                                ${"navbar_{$y}_align"} = get_theme_mod("soptis_footer_column_3_navbar_number_{$y}_align", "center");
                                ${"navbar_{$y}_title"} = get_theme_mod("soptis_footer_column_3_navbar_number_{$y}_title", "navbar title");
                                ${"navbar_{$y}_links"} = get_theme_mod("soptis_footer_column_3_navbar_number_{$y}_navbar_link", '<li><a href="'.esc_url( home_url() ).'">Sample Page</a></li>' );
                    ...
                    if($navbar_boolean){
                        echo '<div class="navbar_container">';
                            ...
                            for($y=1; $y <= $navbar_number; $y++){
                                ...
                                ${"navbar_{$y}_links"} = get_theme_mod("soptis_footer_column_{$i}_navbar_number_{$y}_navbar_link", '<li><a href="'.esc_url( home_url() ).'">Sample Page</a></li>' );
                ...
                if( $i === 2){
                    ...
                    $socials_boolean = (bool) get_theme_mod("soptis_footer_column_2_social_icons", true);
                    if($socials_boolean){

                        $socials_icons_align_value_db = get_theme_mod("soptis_footer_column_2_social_icons_align", "center");
                        ...
                        echo '<div '. $socials_icons_style .' class="social_icons">';
                            ...
                            foreach ( $socials as $handle ) {
                                ...
                                ${"social_{$handle}_enabled"} = (bool) get_theme_mod("soptis_footer_column_2_social_{$handle}_enable", true);
                                ${"social_{$handle}_url"} = esc_url( get_theme_mod("soptis_footer_column_2_social_{$handle}_url"), "/" );

                                if(${"social_{$handle}_enabled"} ){
                                    echo ' 
                                        <a href="'.esc_url( home_url() ).${"social_{$handle}_url"} . '"> 
                            ...
                            foreach ( $socials as $handle ) {
                                ...
                                ${"social_{$handle}_enabled"} = (bool) get_theme_mod("soptis_footer_column_2_social_{$handle}_enable", false);
                                ${"social_{$handle}_url"} = esc_url( get_theme_mod("soptis_footer_column_2_social_{$handle}_url"), "/" );
                    ...
                    if($socials_boolean){
                        ...
                        echo '<div '. $socials_icons_style .' class="social_icons">';
                            ...
                            foreach ( $socials as $handle ) {
                                ...
                                ${"social_{$handle}_enabled"} = (bool) get_theme_mod("soptis_footer_column_{$i}_social_{$handle}_enable", true);
                            ...
                            foreach ( $socials as $handle ) {
                                ...
                                ${"social_{$handle}_enabled"} = (bool) get_theme_mod("soptis_footer_column_{$i}_social_{$handle}_enable", false);
                                ${"social_{$handle}_url"} = esc_url( get_theme_mod("soptis_footer_column_{$i}_social_{$handle}_url"), "/" );
