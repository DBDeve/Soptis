<?php
    ...
    for( $i = 1; $i <= 4; $i++ ){
        ...
        $wp_customize->add_setting( "soptis_footer_column_{$i}_social_icons_align", array(
            'default'           => 'center',
        ...
        $wp_customize->add_control( "soptis_footer_column_{$i}_social_icons_align_control", array(
            'label'    => " column {$i} address alignment ",
            'section'  => "tema_footer_column_{$i}",
            'settings' => "soptis_footer_column_{$i}_social_icons_align",
            'type'     => 'select',
    ...
    function show_social_1() { 
        return get_theme_mod( "soptis_footer_column_1_social_icons", false ) === true;
    };
    function show_social_2() { 
        return get_theme_mod( "soptis_footer_column_2_social_icons", false ) === true;
    };
    function show_social_3() { 
        return get_theme_mod( "soptis_footer_column_3_social_icons", false ) === true;
    };
    function show_social_4() { 
        return get_theme_mod( "soptis_footer_column_4_social_icons", false ) === true;
    };
